  ...
  <div id="NetworkingTop">
    ...
    <div id="body">
      <el-tabs v-model="activeName" class="demo-tabs" stretch="true" @tab-click="handleClick">
        <el-tab-pane label="Define Yourself" name="first">
          <div>
            <p style="margin-bottom: 50px; text-align: left; margin-left: 5rem">“Define Yourself” type of questions
              ...
              <div>
                ...
                <div class="DYdiv">
                  ...
                  <div>
                    ...
                    <ul class="DYul">
                      <li>The company’s missions, recent challenges, products, customers, and your intended position’s
                    ...
                    <ul class="DYul">
                      <li>Navigate through the company’s website, LinkedIn page, other social media page, news,
                        employers, etc.
                      </li>
                    </ul>
                  </div>
              ...
              <div>
                ...
                <div class="DYdiv" style="align-items: center">
                  ...
                  <div>
                    ...
                    <ul class="DYul">
                      <li>Reflect on <span style="font-weight: 500">what</span> you are excel at and <span
                          style="font-weight: 500">why</span> you want to apply for this position in this company.
                      </li>
                    ...
                    story</span> of you in a past-present-future structure
                      ...
                      <li>Connect your <span style="font-weight: 500">past experiences</span> with what the company is
            ...
            <div style="text-align: right; margin-top: 82px; margin-bottom: 50px; padding: 0 5%">
              ...
              <img src="/interview/arrow.svg" @click="$router.push('/interview#more-resources')"
                   style="vertical-align: middle; width: 22px">
            </div>

          </div>
        </el-tab-pane>
        <el-tab-pane label="Behavioral" name="second">
          <div>
            <p id="BQp" style="text-align: left; margin-left: 5rem; margin-bottom: 50px;">Behavioral questions help the
              company to learn about how you would <strong>behave</strong> and <strong>deal with tough
                situations</strong> in
              the real workplace so that they can anticipate your performance. These are usually about <strong>soft
                skills</strong>
        ...
        <el-tab-pane label="Technical" name="third">
          <div>
            <p id="TQp" style="text-align: left; margin-left: 5rem; margin-bottom: 50px;">This part can vary a lot by
              different professions. Technical questions are usually <strong>specific to the topics
                in your fields</strong>. They help the company to evaluate your ability, skillset, professional level,
              and your
              potential to contribute to this specific position. </p>
            <img src="/interview/sampleQ2.svg">
            <div>
              <h3 id="TQtipsTitle" style="margin-top: 3rem; margin-left: 0.5vw; margin-bottom: 2vh; font-size: 26px">
                Tips:</h3>
              <div id="TQtips" style="text-align: left; margin-left: 2vw">
                ...
                <ul style="margin-left: 8vw;">
                  <li><em>E.g. For software engineers, enter “software engineers interview cheat sheet”</em>.</li>
                </ul>
